        ...
        <lable><b>Date</b></lable>
         ...
         <i class="fa fa-calendar">
            ...
            <option>${event.name}</option>
				...
				<input type="file" id="fileinput" name="temp_image" size="50" accept="image/*" />
			</div>
...
<div class = "box">
 ...
 <c:forEach var="temps" items="${res}">
 <div class="col-md-3"> 
  
 <a href = "tempdownload/${temps.path}"><img class="img-responsive" style="height:225px;width:150px" src="ctemplate/${temps.path}"alt=""></a>
 <p>${temps.name}</p>
