        ...
        <div class="row">
            ...
            <div class="box">
                ...
                <div class = "col-md-4">
                    ...
                    <div class =""><button type="button" class = "btn btn-primary" style="width:125px"
                    ...
                    <form action ="usergetdata" method ="POST">
                        ...
                        <div class="col-md-6"><a href="signin">Sign in From Here</a></div>
                        <div class ="col-md-6 text-right">
                            <button type ="submit" class ="btn btn-primary">Log IN</button>
                        </div>
                </form> 
                    ...
                    <div class ="row">
                                            ...
                                            <div class="col-md-3"></div> <div><img class="img-responsive text-center" style="width:125px;height:125px" src="img/SeasoanlBuddy.png" alt="" align="middle"></img></div> 
