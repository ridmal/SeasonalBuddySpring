        ...
        <div class = "col-lg-2"></div>
            <div class="box3 col-lg-8">
                <div class="col-lg-12">
                    ...
                    <form:form method ="POST" action ="merchantsavedata" commandName="candidate" modelAttribute="merchant" enctype="multipart/form-data">
                          
                        <div class ="form-group">
                            <label for="name1" class ="sr-only">Merchant UserName</label>
                            <input type ="text" id ="name1" name ="muname" class = "form-control" placeholder="Enter the Username for Merchant">
                        </div>
                          <div class ="form-group">
                            <label for="name1" class ="sr-only">UserName of SeasonalBuddy</label>
                            <input type ="text" id ="name1" name ="uname" class = "form-control" placeholder="Enter the User Name of SeasonalBuddy">
                        </div>
                        <div class ="form-group">
                            <label for ="pass" class ="sr-only">Password</label>
                            <input type ="password" name ="mpass" id ="mpass" class = "form-control" placeholder="Enter the password">
                        </div>
