        ...
        <lable><b>Date</b></lable>
         ...
         <i class="fa fa-calendar">
            ...
            <option>${event.name}</option>
				...
				<input type="file" id="fileinput" name="clip_image" size="50" accept=".jpg" />
			</div>
...
<div class = "box">
 ...
 <a href = "clipdownload/${clips.path}"><img class="img-responsive" style="height:225px;width:150px" src="clips/${clips.path}"alt=""></a>
 <p>${clips.path}</p>
