    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="text-center"> <h3 style="color:white">Download will Start in next 5 seconds...</h3></div>
                    <div class = "well text-center"> Thank You For Downloading Our Seasonal Buddy Mobile App..</div>   
            </div>
